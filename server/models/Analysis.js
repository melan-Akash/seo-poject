...
const analysisSchema = new mongoose.Schema({
    ...
    overallScore: { type: Number, min: 0, max: 100, default: 0 }, // Fixed: mongoose → Number
    categories: {
    ...
    metaData: {
        ...
        twitterCard: { type: String, default: "" }, // Fixed: twitterCrad → twitterCard
        viewport: { type: String, default: "" }, // Fixed: viewprot → viewport
    ...
    images: {
        total: { type: Number, default: 0 },
        missingAlt: { type: Number, default: 0 }, // Fixed: missingAt → missingAlt
